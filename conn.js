...
const isOwner = [`${setting.ownerNumber}`,"6285718828566@s.whatsapp.net","6285718828566@s.whatsapp.net"].includes(sender) ? true : false
...
_Admin 1 : 0857-1882-8566_
_Admin 2 : 0857-1882-8566_
...
const gurbot = '6281548907132@s.whatsapp.net'
...
var opt = { packname: 'XynaBot,', author: 'By AraChan' }
